...
def inject_custom_css(current_view):
    ...
    st.markdown(f"""
        ...
        [data-testid="collapsedControl"], [data-testid="stExpandSidebarButton"] {{
            ...
            box-shadow: 0 4px 20px rgba(0,0,0,0.4), 0 0 15px rgba(0, 210, 255, 0.15) !important;
            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1) !important;
            cursor: pointer !important;
        }}
        [data-testid="collapsedControl"]:hover, [data-testid="stExpandSidebarButton"]:hover {{
            border-color: rgba(0, 210, 255, 0.5) !important;
            box-shadow: 0 4px 25px rgba(0,0,0,0.5), 0 0 25px rgba(0, 210, 255, 0.3) !important;
            transform: scale(1.05) !important;
            background: rgba(10, 11, 24, 0.95) !important;
        }}
        [data-testid="collapsedControl"] svg, [data-testid="stExpandSidebarButton"] svg,
        [data-testid="collapsedControl"] span, [data-testid="stExpandSidebarButton"] span {{
            color: #00d2ff !important;
            stroke: #00d2ff !important;
        }}

        /* Style the open sidebar collapse button */
        ...
        .block-container {{ padding-top: 3rem; padding-bottom: 3rem; max-width: 95%; position: relative; z-index: 5; }}
